...
class CustomToolbarScrollBehavior(
    ...
    //С помощью интерфейса NestedScrollConnection мы можем реагировать на
    // события скролла иерархии компонентов внутри контейнера.
    val nestedScrollConnection = object : NestedScrollConnection {

        //Здесь мы не будем реагировать на скролл контента вниз, позволяя контенту под тулбаром
        // сначала обработать доступный ему скролл. В этом случае в качестве consumed-значения скролла
        // мы возвращаем 0, поскольку никакой скролл наш компонент пока не использовал.
        ...
        //Обработка флинг-жеста - резкий свайп вверх или вниз
